...
class SHOnRootQuadrupleThenMCTSWithUCT(progress: BackgammonGamesProgress) : BackgammonAI(progress), MonteCarloTreeSearch, SequentialHalving {
    ...
    override fun simulate(node: BackgammonNode, simulationsLimit: Int) {
        val simulationsLeft = sequentialHalving(node, simulationsLimit, progress, 4)
