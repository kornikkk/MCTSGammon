...
class SequentialHalvingV2(progress: BackgammonGamesProgress) : BackgammonMCTS(progress) {
    ...
    override fun simulate(node: BackgammonNode, simulationsLimit: Int) {
        var simulationsLeft = sequentialHalving(node, simulationsLimit)
     ...
     */
    private fun sequentialHalving(node: BackgammonNode, simulationsLimit: Int): Int {
        ...
        val childBudget = countPlayouts(simulationsLimit, childrenCount, childrenCount)
